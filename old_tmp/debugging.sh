...
g++ -Wall -std=c++11 tmp_config.o debugging.cpp pin_manager.o carg_filter.o data_packet.o shift_reg.o port_manager.o io_service.o -o debugging.exec && ./debugging.exec
